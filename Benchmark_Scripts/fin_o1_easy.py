...
def main():
    ...
    input_path = "FinEval-LLM-Financial-Reasoning-Benchmark/Financial_Reasoning_Datasets/easy.jsonl"
    output_path = "FinEval-LLM-Financial-Reasoning-Benchmark/Fin_o1/Benchmark_Result/fin_o1_easy.jsonl"
