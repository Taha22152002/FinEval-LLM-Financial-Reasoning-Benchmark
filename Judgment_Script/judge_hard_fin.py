...
def parse_args(argv: list[str]):
    ...
    p.add_argument("--path", default="FinEval-LLM-Financial-Reasoning-Benchmark/Fin_o1/Benchmark_Result/fin_o1_hard.jsonl")
    p.add_argument("--api_key", default=None)
    p.add_argument("--model", default="gemini-2.5-pro")
    p.add_argument("--out", default="FinEval-LLM-Financial-Reasoning-Benchmark/Fin_o1/Judgement_Result/fin_o1_hard_judgement.jsonl")
